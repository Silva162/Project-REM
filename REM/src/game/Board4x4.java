...
public class Board4x4 extends javax.swing.JFrame {

    /**
     * Creates new form Board4x4
     */
    public Board4x4() {
        initComponents();
    }
    ...
    private void startGameButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        for (int i = 0; i<= 15; i++){
            System.out.print(i + ": ");
            int type = Controller.get4x4TileType(i);
    ...
    private void Tile11ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        type = Controller.get4x4TileType(ID);
        buttonPress(ID, type);
    }
    ...
    //Shows the shapes to the player for a small duration of time, then returns the buttons to blank again.
        ...
        Thread thread = new Thread() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(Board4x4.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        };
        thread.start(); 
